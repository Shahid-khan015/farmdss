...
def test_rear_ballast_zero_when_slip_within_target():
    assert rear_ballast_required_kg(  # returns (ballast_kg, problem)
        slip_pct=10.0,
        draft_n=1350.0,
        rear_axle_load_n=9000.0,
        rsr_n=14715.0,
...
def test_rear_ballast_r_prime_fixed_point_satisfies_r_prime_equals_d_over_mu():
    ...
    br_r_kg, problem = rear_ballast_required_kg(
        slip_pct=18.0,
        draft_n=draft_n,
        rear_axle_load_n=9000.0,
        ci_kpa=1200.0,
...
def test_rear_ballast_reports_infeasibility_instead_of_raising():
    """Soft soil under a heavy axle cannot develop the pull at the 15% target slip.
